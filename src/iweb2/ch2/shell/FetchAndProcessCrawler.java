...
/**
 * 
 * @ClassName: FetchAndProcessCrawler 
 * @Description: 爬取并且处理爬取的结果
 * @author anduo
 * @date 2015年1月29日 下午2:00:50 
 *
 */
public class FetchAndProcessCrawler {
    ...
    //URL过滤器，用来过滤掉不需要爬取的url
    URLFilter urlFilter;

    /**
     * 
     * <p>Title: FetchAndProcessCrawler</p> 
     * <p>Description: 初始化一个爬取处理实例</p> 
     * @param dir 用来存储爬取数据的文件夹
     * @param maxDepth 爬取深度
     * @param maxDocs 爬取的最大文档数限制条件
     */
     ...
     * 
     * @Title: run 
     * @Description: 开始爬取指定url并且开始处理爬取结果
     */
    public void run() {
